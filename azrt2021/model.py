...
class Model:
    ...
    def fit(self, dset_trn, dir_rsl, **kwargs):
        ...
        # Use .to() instead of .cuda() to support both CPU and CUDA
    ...
    def load_model(self, fp):
        ...
        self.nn = torch.load(fp, weights_only=False)
    ...
    def to(self, device):
        ...
        """
        # Accept 'cpu', 'cuda:0' format, or integer device IDs
        ...
        self.nn.to(device_str)
        self.nn.device = device_str
